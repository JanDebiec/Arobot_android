...
//		setHasOptionsMenu(true);
		mRootView = inflater.inflate(R.layout.fragment_bluetooth, container,
				false);
    ...
    private void setupChat() {
        ...
        mConversationView = (ListView) mRootView.findViewById(R.id.in);
        mConversationView.setAdapter(mConversationArrayAdapter);

        // Initialize the compose field with a listener for the return key
        mOutEditText = (EditText) mRootView.findViewById(R.id.edit_text_out);
        ...
        mSendButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                TextView view = (TextView) mRootView.findViewById(R.id.edit_text_out);
        ...
        mChatService = ((MainActivity)getActivity()).getChatService();;
    ...
    public void onDestroy() {
        ...
        // stop disabled, chat must run for SensorMovementFragment.
        //MainActivity will stop Chat Service
 //       if (mChatService != null) mChatService.stop();
    ...
    private void sendMessage(String message) {
        ...
        if (mChatService.getState() != BluetoothService.STATE_CONNECTED) {
            Toast.makeText(getActivity().getApplicationContext(), R.string.not_connected, Toast.LENGTH_SHORT).show();
            return;
        }
